  ...
  helpData = [
    {
      ...
      data: [
        ...
        },
        {
          name: "Daily Volume",
          htmlText:
            "<p>Volume is a measure of demand on a corridor. Total volume on main street through phases are summed over each Tuesday, Wednesday and Thursday, and then averaged over all days in the month.</p>",
        },
        {
          name: "Pedestrians",
          htmlText:
            "<p>Pedestrian activity is the total number of pedestrian pushbutton events recorded by hour and by day. It is calculated over Tuesdays, Wednesdays and Thursdays.</p>",
        },
      ],
    },
    {
      ...
      data: [
        ...
        },
        {
          ...
          htmlText:
            "<p>These are the monthly reports produced monthly by RTOP Corridor Managers detailing key activities, maintenance tasks and action items for the month.</p>",
        },
      ],
    },
    {
      ...
      data: [
        {
          name: "Dashboard",
          htmlText:
            "The home page of the SigOps Metrics website. This shows a high level overview of performance, volume, equipment, and TEAMS metrics at a filtered system and signal level.",
        },
        {
          name: "Watchdog",
          htmlText:
